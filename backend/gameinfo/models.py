...
class Match(models.Model):
    ...
    match_winner = models.ForeignKey(User, related_name='winner_player', on_delete=models.CASCADE)
...
class PlayerStats(models.Model):
    ...
    player = models.ForeignKey(User, related_name='player_stats', on_delete=models.CASCADE)
